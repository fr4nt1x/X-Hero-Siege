...
function explosions( event )
	...
	for i = 1, explosions_per_tick do
		...
		local meteor = ParticleManager:CreateParticle("particles/econ/items/clockwerk/clockwerk_paraflare/clockwerk_para_rocket_flare_explosion.vpcf", PATTACH_CUSTOMORIGIN, caster)
		ParticleManager:SetParticleControl(meteor, 3, point + Vector(0,0,128))
