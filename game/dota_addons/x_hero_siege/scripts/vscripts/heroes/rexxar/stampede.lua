function create_projectile( event )
	...
	local skulls_per_tick = ability:GetLevelSpecialValueFor("projectiles_per_tick", ability:GetLevel()-1)
	...
	for j = 1,skulls_per_tick do
		...
		{
			Ability = ability,
        	EffectName = "particles/units/heroes/rexxar_stampedejaina/rexxar_stampede.vpcf",
