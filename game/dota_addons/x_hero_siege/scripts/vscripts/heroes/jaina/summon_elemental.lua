...
function spawn_servant( event )
	...
	local unitsToSpawn = {"npc_sea_elemental_I","npc_sea_elemental_II","npc_sea_elemental_III","npc_sea_elemental_III"}
	if hero:IsRealHero() then
		...
		for i = 1,servant_units do
			...
			ability:ApplyDataDrivenModifier(hero, unit, "modifier_sea_elemental", {})
